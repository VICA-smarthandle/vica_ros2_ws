...
#
# 2026-08-29 하드웨어 실측(사용자 확정):
#   차체 61 cm (앞뒤 대칭이라 +-0.305) · 손잡이 11 cm 돌출 · 총 세로 72 cm
...
#
# 2026-08-29에 손잡이가 19 -> 11 cm로 한 번 더 줄어 후방이 -0.415가 됐고, 외접은
# 0.5516 -> 0.4727 m다(회전 필요 직경 1.10 -> 0.95 m). 내접은 여전히 0.275 m다.
# 아래 문단들의 0.5516은 그 회차의 기록으로 남긴다 -- 판정은 어느 쪽으로도 바뀌지
# 않는다. inflation 0.56이 0.5516을 덮었다면 0.4727은 더 넉넉히 덮기 때문이다.
#
