...
#     """
#
# 근거: mdrobot_can_control, vica_safety, encoder_feedback 등 기존 패키지가 모두 이
# 형태를 쓴다. ament 기본 convention은 D213을 검사하므로 빼지 않으면 저장소 전체가
# 이 검사를 통과하지 못한다(mdrobot_can_control도 현재 통과하지 않는다).
_EXTRA_IGNORE = 'D213'
