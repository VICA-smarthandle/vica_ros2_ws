...
#define US_ANGLE_LEVEL 0x02 // 지향각 레벨 2(40°) — 2026-09-01 운영 확정.
                            // 50°(호 폭 1.31m)를 운영에 올려 보니 좁은 곳 과잉
                            // 봉쇄가 체감으로 심해져(사용자 보고), 실주행 8회차에서
                            // 양립을 검증한 40°(호 폭 1.05m)로 복귀한다. 다른 조건
                            // (max_range 1.5m·레이어 분리)은 무변경.
                            // ROS fov 0.698 과 일치시킬 것.
